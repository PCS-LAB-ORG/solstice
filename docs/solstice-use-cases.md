...
### 11. "Show me everything for my theatre"

**Who:** Any theatre RC or team lead — EMEA, JAPAC, AMER, or LATAM lead wants their own scoped view without other theatres in the mix.

**Solution → Theatre filter (present on every page)**

- All pages: `All | EMEA | AMER/NAM | JAPAC | LATAM` pills in page header.
- Selecting a theatre filters: funnel, weekly tracker, M1 plan, CSE workload, blockers, forecast, audit, daily briefing — all scoped instantly.
